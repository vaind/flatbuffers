...
Most consumers will want to use the [`flatc` - FlatBuffer compiler](https://github.com/google/flatbuffers/releases)
binary for your platform matching the pub.dev package version.
